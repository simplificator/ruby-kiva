...
%w( dynamic_initializer api location image paged_array video terms loan borrower
    payment lender partner country lending_action journal_entry comment team).each do |name|
